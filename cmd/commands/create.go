...
func Create(di *injectors.Injector) error {
	...
	contentBody := fmt.Sprintf(
		...
		helpers.MakeStyled("htmx", &helpers.StringStyle{Color: variables.ColorBlue}),
		helpers.MakeStyled(strconv.FormatBool(di.Config.Frontend.IsUseHyperscript), &helpers.StringStyle{Color: variables.ColorBlue}),
