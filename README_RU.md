...
использованием встроенного пакета `net/http`) с **htmx** и **hyperscript** 
доступно в HTML-шаблонах Go.
...
Команда для создания нового проекта с заданным **Go** бэкендом, **htmx** и 
**hyperscript**.
...
> 💡 Примечание: Если не указывать название Go бэкенда, то по умолчанию 
> `gowebly` CLI создает новый проект со встроенным пакетом 
> [net/http][net_http_url].

Вы можете выбрать **Go** бэкенд для своего проекта:

| Бэкенд     | Описание                                                                    |
|------------|-----------------------------------------------------------------------------|
| `fiber`    | Создать проект с Go бэкендом и веб-фреймворком [Fiber][fiber_url]           |
| `echo`     | Создать проект с Go бэкендом и веб-фреймворком [Echo][echo_url]             |
| `chi`      | Создать проект с Go бэкендом и композитным роутером [chi][chi_url]          |

### `add`

Команда для добавления в проект одного из самых популярных 
атомарных/утилитарных **CSS-фреймворков**. _Это не обязательно, а опционально._
...
Вы можете выбрать **CSS-фреймворк** для своего проекта:

| CSS-фреймворк | Описание                                                            |
|---------------|---------------------------------------------------------------------|
| `tailwindcss` | Добавить [Tailwind CSS][tailwindcss_url] во фронтенд вашего проекта |
| `unocss`      | Добавить [UnoCSS][unocss_url] во фронтенд вашего проекта            |
...
**hyperscript** и популярных атомарных/утилитарных **CSS-фреймворков**.
