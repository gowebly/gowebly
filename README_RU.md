...
**net/http** (в качестве бэкенда Go), **htmx**, **hyperscript** и **UnoCSS** 
...
Но вы можете выбрать любой **Go-бэкенд** с портом для вашего проекта (_это 
обязательно_):

| Имя Go-бэкенда | Описание                                                                                         |
|----------------|--------------------------------------------------------------------------------------------------|
| `default`      | Создайте новый проект с Go-бэкендом с использованием встроенного пакета [net/http][net_http_url] |
| `fiber`        | Создайте новый проект с Go-бэкендом с использованием веб-фреймворка [Fiber][fiber_url]           |
| `echo`         | Создайте новый проект с Go-бэкендом с использованием веб-фреймворка [Echo][echo_url]             |
| `chi`          | Создайте новый проект с Go-бэкендом с использованием композитного маршрутизатора [chi][chi_url]  |
